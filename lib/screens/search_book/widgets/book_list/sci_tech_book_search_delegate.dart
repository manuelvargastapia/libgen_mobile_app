...
import 'sci_tech_results_builder.dart';
import 'show_sci_tech_filter_dialog.dart';

class SciTechBookSearchDelegate extends SearchDelegate {
  FiltersSciTechModel filters = FiltersSciTechModel();

  BuildContext context;
  BookBloc bookBloc;
  HiveBloc<Suggestion> hiveBloc;

  SciTechBookSearchDelegate({
  ...
  List<Widget> buildActions(BuildContext context) {
    return [
      ...
      IconButton(
        ...
        onPressed: () async {
          filters = await showSciTechFilterDialog(
            context: context,
            currentQuery: query,
